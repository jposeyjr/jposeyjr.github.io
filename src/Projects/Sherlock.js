...
const Sherlock = () => {
  const sherlockText =
    'Sherlock is a SASS application in development for those with vision impairments. You can enter a websites URL and get back image alt text is it is missing, form labels for forms without them and text from the site in a response area.';
